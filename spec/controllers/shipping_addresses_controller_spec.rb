...
RSpec.describe ShippingAddressesController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all shipping_addresses as @shipping_addresses" do
      ...
      expect(assigns(:shipping_addresses)).to eq([shipping_address])
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created shipping_address as @shipping_address" do
        ...
        expect(assigns(:shipping_address)).to be_persisted
      end

      it "redirects to the created shipping_address" do
        post :create, {:shipping_address => valid_attributes}, valid_session
        expect(response).to redirect_to(ShippingAddress.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved shipping_address as @shipping_address" do
        post :create, {:shipping_address => invalid_attributes}, valid_session
        expect(assigns(:shipping_address)).to be_a_new(ShippingAddress)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested shipping_address" do
        shipping_address = ShippingAddress.create! valid_attributes
        put :update, {:id => shipping_address.to_param, :shipping_address => new_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns the shipping_address as @shipping_address" do
        shipping_address = ShippingAddress.create! valid_attributes
        put :update, {:id => shipping_address.to_param, :shipping_address => invalid_attributes}, valid_session
        expect(assigns(:shipping_address)).to eq(shipping_address)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the shipping_addresses list" do
      shipping_address = ShippingAddress.create! valid_attributes
      delete :destroy, {:id => shipping_address.to_param}, valid_session
      expect(response).to redirect_to(shipping_addresses_url)
    end
  end
